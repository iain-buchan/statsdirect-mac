...
function App(){
  ...
  return <main><header><div><div className="eyebrow">ANALYSIS / STATSDIRECT</div><h1>{config.title}</h1><p>Results and charts open as separate reports in the Window menu.</p></div><button onClick={()=>native('help')}>Method help ↗</button></header>
