...
swiftc -target arm64-apple-macosx14.0 -module-cache-path "$BUILD_WORK/swift-cache" Sources/main.swift Sources/RPane.swift Sources/WindowFrame.swift Sources/GridHost.swift Sources/ExcelHost.swift Sources/AnalysisHost.swift Sources/ChartHost.swift -o "$APP/Contents/MacOS/StatsDirectViewer" -framework Cocoa -framework WebKit
